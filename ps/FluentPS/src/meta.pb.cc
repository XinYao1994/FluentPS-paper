...
const int PBMeta::kStalenessFieldNumber;
...
// @@protoc_insertion_point(message_clear_start:ps.PBMeta)
  ...
  if (cached_has_bits & 768u) {
    ::memset(&staleness_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&customer_id_) -
        reinterpret_cast<char*>(&staleness_)) + sizeof(customer_id_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
      ...
      case 10: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitiveNoInline<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 1, 82u, input, this->mutable_data_type())));
        } else {
          goto handle_unusual;
        }
        break;
...
void PBMeta::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000100u) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(9, this->staleness(), output);
  }
  ...
  if (cached_has_bits & 0x00000200u) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(11, this->customer_id(), output);
  }
...
void PBMeta::InternalSwap(PBMeta* other) {
  ...
  swap(staleness_, other->staleness_);
  swap(customer_id_, other->customer_id_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_cached_size_, other->_cached_size_);
