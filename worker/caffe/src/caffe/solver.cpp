...
#ifdef Delay_Add
template <typename Dtype>
void Solver<Dtype>::InitGuassRand(double mean, double sdev, int node_id){
	delay_generator = new std::default_random_engine(time(0));
	delay_distribution = new std::normal_distribution<double>(mean, sdev);
