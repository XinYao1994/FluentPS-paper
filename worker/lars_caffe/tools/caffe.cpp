...
#ifdef Delay_Add
	solver->InitGuassRand(FLAGS_delay_mean, FLAGS_delay_sdev, FLAGS_delay_node);
#endif
	if (FLAGS_snapshot.size()) {
...
int main(int argc, char** argv) {
	...
	// PS INIT
	ps::Start(0, 5000); //start with setting timeout
