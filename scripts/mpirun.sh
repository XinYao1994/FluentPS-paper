...
echo "create ${DMLC_NUM_WORKER} workers"
cd ${project_path}/${model}; 
mpirun_rsh -hostfile ${host_file} -n ${DMLC_NUM_WORKER} MV2_USE_RDMA_CM=0 ${scripts_path}/mpi_sworker.sh ${DMLC_NUM_SERVER} ${DMLC_NUM_WORKER} ${worker} ${solver} ${arg}
