...
${worker} train --solver=${solver} --delay_mean=${delaymean} --delay_sdev=${delaysdev} --delay_node=${delaysnode} 
#2> ${project_path}/logs/W${no}_caffe_${stype}_${stale}_${propa}_${DMLC_NUM_SERVER}_${DMLC_NUM_WORKER}_${delaymean}_${delaysdev}_${delaysnode} > ${project_path}/logs/W${no}_caffe_${stype}_${stale}_${propa}_${DMLC_NUM_SERVER}_${DMLC_NUM_WORKER}_${delaymean}_${delaysdev}_${delaysnode}_para &
